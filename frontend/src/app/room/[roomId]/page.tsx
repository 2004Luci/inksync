        ...
        <div className="flex items-center gap-3">
          ...
          {isSignedIn && (
            <button
              ...
              className="px-3 py-1.5 text-sm bg-[var(--surface-hover)] hover:bg-[var(--primary)] hover:text-black border border-[var(--border)] rounded-lg transition-colors hidden sm:inline-flex items-center gap-1.5"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
