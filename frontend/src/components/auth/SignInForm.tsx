    ...
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        <button
          ...
          className="w-full py-3 px-4 bg-white text-gray-800 font-medium rounded-lg flex items-center justify-center gap-3 hover:bg-gray-100 transition-colors"
        >
        ...
        <button
          ...
          className="w-full py-3 px-4 bg-[#24292e] text-white font-medium rounded-lg flex items-center justify-center gap-3 hover:bg-[#2f363d] transition-colors"
        >
